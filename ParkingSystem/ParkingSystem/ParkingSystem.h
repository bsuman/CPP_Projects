...
big, medium, or small, which are represented by 1, 2, and 3 respectively. A car can only park in a parking space of its carType. 
...
class ParkingSystem {
private: 
	int num_big,num_small,num_medium;
